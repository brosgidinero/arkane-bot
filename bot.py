...
# ===============================
TOKEN = os.getenv("7785980824:AAHPZhuaGMv4cVm5LajHywCMAnCVRCnTBUQ")
AV_KEY = os.getenv("HBK3Q0MCWJ4VTZ68")
FINNHUB_KEY = os.getenv("d4aajspr01qnehvtnft0d4aajspr01qnehvtnftg")
TWELVE_KEY = os.getenv("6bbb8ba1205544f899cbd7cd602cfa0f")

# ✅ ID DEL CANAL (como número)
CHAT_ID = int(os.getenv("-1003305524490", "0"))

# Validación rápida (evita que crashee sin explicación)
